                        ...
                        <a href="{{ url('tutorial/'.$all_cate_item->slug) }}" class="text-decoration-none">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="text-dark">{{ $all_cate_item->name }}</h4>
                                </div>
                            </div>
                        </a>
                    </div>
...
<div class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4>Tadween Blog System</h4>
                <div class="underline"></div>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas modi beatae doloribus dolores fugit quos tempora maiores quae ducimus, illo ab eum sint cum mollitia nam aliquam est non eius.
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas modi beatae doloribus dolores fugit quos tempora maiores quae ducimus, illo ab eum sint cum mollitia nam aliquam est non eius.
                </p>
            </div>
        </div>
